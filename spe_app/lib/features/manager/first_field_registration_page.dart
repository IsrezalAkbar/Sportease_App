...
import '../media/cloudinary_controller.dart';
...
class FirstFieldRegistrationPage extends ConsumerStatefulWidget {
  const FirstFieldRegistrationPage({super.key});

  @override
  ConsumerState<FirstFieldRegistrationPage> createState() =>
      _FirstFieldRegistrationPageState();
}

class _FirstFieldRegistrationPageState
    extends ConsumerState<FirstFieldRegistrationPage> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      'Daftarkan lapangan pertama Anda untuk memulai. Setelah disetujui admin, Anda dapat menambahkan lapangan lainnya.',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.white,
                        height: 1.4,
                  ...
                  : () async {
                      final confirm = await showDialog<bool>(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: const Text(
                            'Yakin ingin keluar? Data yang diisi akan hilang.',
                          ),
                          actions: [
                            TextButton(
